    ...
    if home_num == 1:
        ...
        if score > 5:
            ...
            if pygame.Rect.colliderect(ast2.objrect, jetrect) == True:
                wmov = [random.randint(-ast2.objrect.left, 750 - ast2.objrect.left), -ast2.objrect.top]
                ...
                for event in pygame.event.get():
                    if event.type == pygame.MOUSEBUTTONDOWN and event.button == 1:
                        ...
                        if 10 < mouse[0] < 149 and 80 < mouse[1] < 130:
                            home_num = 0
                            ending_num = 0
                            ast2.objrect = ast2.objrect.move(wmov)
                            score = 0
        ...
        if score > 10:
            ...
            if pygame.Rect.colliderect(ast3.objrect, jetrect) == True:
                wmov = [random.randint(-ast3.objrect.left, 750 - ast3.objrect.left), -ast3.objrect.top]
                ending_num = 1
                end_text = font1.render("Game Over : " + str(score), True, "red")
                end_textrect = end_text.get_rect()
                mov = [10, 10]
                ...
                for event in pygame.event.get():
                    if event.type == pygame.MOUSEBUTTONDOWN and event.button == 1:
                        ...
                        if 10 < mouse[0] < 149 and 80 < mouse[1] < 130:
                            home_num = 0
                            ending_num = 0
                            ast3.objrect = ast3.objrect.move(wmov)
                            score = 0
                        if 10 < mouse[0] < 116 and 150 < mouse[1] < 200:
                            home_num = 1
                            ending_num = 0
        ...
        if score > 51:
            ...
            if pygame.Rect.colliderect(ast4.objrect, jetrect) == True:
                wmov = [random.randint(-ast4.objrect.left, 750 - ast4.objrect.left), -ast4.objrect.top]
                ending_num = 1
                ...
                for event in pygame.event.get():
                    if event.type == pygame.MOUSEBUTTONDOWN and event.button == 1:
                        ...
                        if 10 < mouse[0] < 149 and 80 < mouse[1] < 130:
                            home_num = 0
                            ending_num = 0
                            ast4.objrect = ast4.objrect.move(wmov)
                            score = 0
                        if 10 < mouse[0] < 116 and 150 < mouse[1] < 200:
                            home_num = 1
                            ending_num = 0
        ...
        if pygame.Rect.colliderect(ast1.objrect, jetrect) == True:
            wmov = [random.randint(-ast1.objrect.left, 750 - ast1.objrect.left), -ast1.objrect.top]
            pygame.event.get()
            ending_num = 1
            end_text = font1.render("Game Over : " + str(score), True, "red")
            end_textrect = end_text.get_rect()
            ...
            for event in pygame.event.get():
                if event.type == pygame.MOUSEBUTTONDOWN and event.button == 1:
                    ...
                    if 10 < mouse[0] < 149 and 80 < mouse[1] < 130:
                        home_num = 0
                        ending_num = 0
                        ast1.objrect = ast1.objrect.move(wmov)
                        score = 0
                    if 10 < mouse[0] < 116 and 150 < mouse[1] < 200:
                        home_num = 1
                        ending_num = 0
